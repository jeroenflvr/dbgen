...
def export_tables_to_parquet(conn, tables, step, prefix, bucket):
    ...
    for table in tables:
        ...
        # check_or_create_table_dir(table, output_dir)
...
def main():
    ...
    OUTPUT_DIR = "/data/output/gen/allparts"  # Directory to save Parquet files
    OUTPUT_PREFIX = "sf3000_gen"
    BUCKET = "tp-bench-data"
